public class ExchangeRateHistory2 {
	...
	public ExchangeRateHistory2(double sixMonthsAgo, double fiveMonthsAgo, 
			double fourMonthsAgo, double threeMonthsAgo, double twoMonthsAgo, double oneMonthAgo, double current) {
